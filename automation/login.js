...
export const login = async ({ page, username = '', password = '' }) => {
    ...
    await inputTargetFilledByLocator({ page, target: 'input[name="username"]', value: username })
    await inputTargetFilledByLocator({ page, target: 'input[name="password"]', value: password })
